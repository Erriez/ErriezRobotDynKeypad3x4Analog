...
function autobuild()
{
    ...
    platformio ci --lib="." ${BOARDS_AVR} ${BOARDS_ARM} ${BOARDS_ESP} examples/ErriezRobotDynKeypad3x4Analog/ErriezRobotDynKeypad3x4Analog.ino
    platformio ci --lib="." ${BOARDS_AVR} ${BOARDS_ARM} ${BOARDS_ESP} examples/ErriezPrintADC/ErriezPrintADC.ino
}
...
function generate_doxygen()
{
    ...
    DOXYGEN_PDF="ErriezRobotDynKeypad3x4Analog.pdf"
